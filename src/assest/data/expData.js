        ...
        content: (
          <div style={{ display: "inline" }}>
            <h1 style={{ display: "inline", fontSize: "inherit" }}>
              ...
              <span className="text-[#08C66C] font-"> Fintechracy </span>,
              where I worked on developing and improving team collaboration
              between the
              <span style={{ fontWeight: "" }}>
                back-end developers
              </span>{" "}
              and the
              <span style={{ fontWeight: "" }}>UI/UX designer</span>. We
              used <span style={{ fontWeight: "" }}>ClickUp</span> for task
    ...
    content: [
        ...
        content: (
          <div style={{ display: "inline" }}>
            <h1 style={{ display: "inline", fontSize: "inherit" }}>
              ...
              and <span >UI/UX designers</span> to
              build medium to large-scale applications.
            </h1>{" "}
      ...
      },
      {
        ...
        content: (
          <div>
            I also developed{" "}
            <span style={{ fontWeight: "" }}>advanced navigation</span>{" "}
            systems, implemented{" "}
            <span style={{ fontWeight: "", }}>
              lazy loading
            </span>{" "}
            for performance improvements, and added an{" "}
      ...
      },
      {
        ...
        content: (
          <div>
            ...
            , further refining my technical skills and problem-solving
            abilities.
          </div>
        ),
      },
